...
$selectQuery = "SELECT * FROM violation";
 ...
 <?php include('includes/sidebar.php');?>
  ...
  <?php include('includes/pagetitle.php');?>
    ...
    <div class="card-header">
        <h3 class="card-title">Violation Data Table</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <a href='edit_violation.php?id={$row['id']}' class='btn btn-primary'><i class='fas fa-edit'></i> Edit</a>
