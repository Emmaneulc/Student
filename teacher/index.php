...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['login'])) {
        ...
        if (empty($password)) {
            ...
            $sql = "SELECT * FROM teacher WHERE emp_id = '$hashed_password'";
            ...
            if ($result->num_rows == 1) {
                ...
                header("Location: report_violation.php");
                exit();
            } else {
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Log in to start your session as Professor</p>
