...
function getTotalMembershipTypesCount()
{
    ...
    $totalMembershipTypesQuery = "SELECT COUNT(*) AS totalViolation FROM violation";
    ...
    if ($totalMembershipTypesResult->num_rows > 0) {
        ...
        return $totalMembershipTypesRow['totalViolation'];
    } else {
        return 0;
    }
}
...
function getExpiringSoonCount()
{
    ...
    $expiringSoonQuery = "SELECT COUNT(*) AS totalViolationReport FROM renew";
    ...
    if ($expiringSoonResult->num_rows > 0) {
        ...
        return $expiringSoonRow['totalViolationReport'];
    } else {
        return 0;
    }
}
...
function getStudentGuardianReport()
{
    global $conn;

    $expiringSoonQuery = "SELECT COUNT(*) AS totalGuardianReport FROM vio_message";
    $expiringSoonResult = $conn->query($expiringSoonQuery);

    if ($expiringSoonResult->num_rows > 0) {
        $expiringSoonRow = $expiringSoonResult->fetch_assoc();
        return $expiringSoonRow['totalGuardianReport'];
    } else {
        return 0;
    }
}
...
function getStudentDepartment()
{
    ...
    $expiringSoonQuery = "SELECT COUNT(*) AS totalDepartment FROM department";
    $expiringSoonResult = $conn->query($expiringSoonQuery);

    if ($expiringSoonResult->num_rows > 0) {
        $expiringSoonRow = $expiringSoonResult->fetch_assoc();
        return $expiringSoonRow['totalDepartment'];
    } else {
        return 0;
    }
}
...
function getStudentSection()
{
    ...
    $expiringSoonQuery = "SELECT COUNT(*) AS totalSection FROM section";
    $expiringSoonResult = $conn->query($expiringSoonQuery);

    if ($expiringSoonResult->num_rows > 0) {
        $expiringSoonRow = $expiringSoonResult->fetch_assoc();
        return $expiringSoonRow['totalSection'];
    } else {
        return 0;
    }
}
...
function getTeacher()
{
    ...
    $expiringSoonQuery = "SELECT COUNT(*) AS totalTeacher FROM teacher";
    $expiringSoonResult = $conn->query($expiringSoonQuery);

    if ($expiringSoonResult->num_rows > 0) {
        $expiringSoonRow = $expiringSoonResult->fetch_assoc();
        return $expiringSoonRow['totalTeacher'];
    } else {
        return 0;
    }
}
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Violation Data</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Report Violation</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Guardian Report</span>
                <span class="info-box-number"><?php echo getStudentGuardianReport(); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo getStudentDepartment(); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Section</span>
                <span class="info-box-number"><?php echo getStudentSection(); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <!-- /.col -->
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total School Professor</span>
                <span class="info-box-number"><?php echo getTeacher(); ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
    ...
    <div class="card-body p-0">
        <ul class="products-list product-list-in-card pl-2 pr-2">
            ...
            while ($row = $recentMembersResult->fetch_assoc()) {
                ...
                echo '<span class="badge badge-dark float-right">' . ($row['created_at']) . '</span>';
                echo 'Student Number: ' . ($row['membership_number']); 
                echo '</span>';
                echo '</div>';
                echo '</li>';
            }
